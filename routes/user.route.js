...
const {getUser, updateUser, deleteUser, createUser, followUser, unfollowUser, acceptFollow, rejectFollow, LogInUser, searchUsers} = require ('../controllers/user.controller.js')
